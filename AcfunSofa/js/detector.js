...
(function() {
    ...
    var r;
//  acfun sofa
    function refresh(){if(window.location.href=="http://www.acfun.tv/v/list110/index_1.htm"||window.location.href=="http://www.acfun.tv/v/list110/index.htm"){ window.location.href = window.location.href;checkSofa();}}
    function checkSofa(){var storage = window.localStorage;$(" .hint-comm-article span").each(function(){if($(this).text()==="0"){console.log($(this).parent()[0].href);if(storage[""+$(this).parent()[0].href] !=1){storage[""+$(this).parent()[0].href] =1;window.open($(this).parent()[0].href);}}});}
